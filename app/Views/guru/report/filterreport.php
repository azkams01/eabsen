...
<?php if ($Kelas == null) { ?>
    <script>
        document.location.href = '<?= base_url() ?>/guru/report'
    </script>
<?php } ?>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="col text-end">
                <a href="<?= base_url() ?>/guru/export_excel_filter?Kelas=<?= $Kelas ?>&tgl_absen=<?= $tgl_absen ?>&Keterangan=<?= $keterangan ?>" target="_blank" data-toggle="tooltip" title="Export" class="btn btn-warning"><i class="fa-solid fa-file-export"></i></a>
            </div>
