        ...
        <div class="col">
            ...
            <div class="row mt-4">
                ...
                <div class="col text-end">
                    <a href="<?= base_url() ?>/guru/export_excel_rekap?keyword=<?= $keyword ?>&NIS=<?= $data_siswa->NIS ?>&Nama=<?= $data_siswa->Nama_siswa ?>&Kelas=<?= $data_siswa->Kelas ?>&Hadir=<?= dataHadir($NIS) ?>&Sakit=<?= dataSakit($NIS) ?>&Izin=<?= dataIzin($NIS) ?>" target="_blank" data-toggle="tooltip" title="Export" class="btn btn-warning"><i class="fa-solid fa-file-export"></i></a>
                </div>
            </div>
