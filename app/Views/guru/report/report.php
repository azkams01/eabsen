        ...
        <div class="col">
            <div class="row mt-4">
                <div class="col">
                    <form action="" method="post">
                        <div class="input-group flex-nowrap" style="width: 250px;">
                            <input class="form-control " type="search" placeholder="Nama / NIS" aria-label="Search" name="keyword" style="opacity: 0.8;">
                ...
                <div class="col text-end">
                    <a href="<?= base_url() ?>/guru/aturFilterReport" data-toggle="tooltip" title="Filter Kehadiran Kelas" class="btn btn-secondary"><i class="fa-solid fa-filter"></i></a>
                    <a href="<?= base_url() ?>/guru/export_excel?keyword=<?= $keyword ?>" target="_blank" data-toggle="tooltip" title="Export" class="btn btn-warning"><i class="fa-solid fa-file-export"></i></a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($history as $hs) { ?>
                            ...
                            <tr>
                                ...
                                <td><a href="<?= base_url() ?>/guru/rekapsiswa?NIS=<?= $hs['NIS'] ?>" data-toggle="tooltip" title="Lihat Rekap Data <?= $pisah[0]; ?>" class="btn btn-sm btn-primary" style="position: relative; z-index: 2;"><i class="far fa-eye"></i></a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
