...
<?php if (session()->getFlashdata('pesanKeteranganHadir')) { ?>
    <script>
        Swal.fire(
            'Hadir',
            ...
            if (result.value == true) {
                document.location.href = '<?= base_url() ?>/guru/keteranganAbsen?keterangan=Hadir'
            }
            document.location.href = '<?= base_url() ?>/guru/keteranganAbsen?keterangan=Hadir'
        })
    </script>
<?php } elseif (session()->getFlashdata('pesanKeteranganLampiran')) { ?>
    <script>
        Swal.fire(
            ...
            if (result.value == true) {
                document.location.href = '<?= base_url() ?>/guru/keteranganAbsen'
            }
            document.location.href = '<?= base_url() ?>/guru/keteranganAbsen'
        })
    </script>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } elseif ($ds['keterangan_absen'] == "Sakit" or $ds['keterangan_absen'] == "Izin") { ?>
                                        <a class="btn btn-sm btn-warning" href="<?= base_url() ?>/guru/pesanKeteranganLampiran?tgl_absen=<?= $ds['tgl_absen']; ?>&keterangan=<?= $ds['keterangan_absen']; ?>&id=<?= $ds['id_absensi'] ?>"> <?= $ds['keterangan_absen']; ?> </a>
                                    <?php } else { ?>
                                        <?= $ds['keterangan_desc'] ?>
                                    <?php } ?>
                                </td>
