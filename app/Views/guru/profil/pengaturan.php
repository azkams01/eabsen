...
<div class="container" style="width: 100%; margin-top: 20px; background-color: white; border-radius: 5px;">
  <div class="row">
    <div class="col p-3" style="padding-top: 20px;">
      <strong style="font-size: 23px;">Biodata Diri</strong> <a href="<?= base_url() ?>/guru/profil"> <button type="button" class="btn btn-secondary" style="float: right;"><i class="fas fa-arrow-left"></i> Kembali</button> </a> <br><br>
      <form style="font-size: 14px;" action="<?= base_url() ?>/guru/profilProses/<?= akunGuru()->NIP ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="NIS" value="<?= akunGuru()->NIP ?>" name="NIS" style="opacity: 0.6;" readonly>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="Nama" value="<?= akunGuru()->Nama_guru ?>" name="Nama" style="opacity: 0.6;" readonly>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="Kelas" name="Kelas" value="<?= akunGuru()->walikelas ?>" style="opacity: 0.6;" readonly>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="email" class="form-control" id="exampleInputEmail1" name="Email" value="<?= akunGuru()->Email_guru ?>" style="opacity: 0.6;" placeholder="Masukan Email" required>
        ...
        <div class="mb-3">
          ...
          <div class="input-group flex-nowrap">
            <input type="password" class="form-control" id="inputPassword" value="<?= akunGuru()->Password_guru ?>" name="Password" aria-label="Username" aria-describedby="addon-wrapping" style="opacity: 0.6;" readonly required>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="nomorTelepon" style="opacity: 0.6;" value="<?= akunGuru()->NomorHp_guru ?>" name="NomorHp" placeholder="Masukan Nomor Telepon" required>
